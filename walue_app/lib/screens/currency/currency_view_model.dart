...
class CurrencyViewModel extends ChangeNotifier {
  ...
  final AsyncValue<CryptoCurrencyData> currencyData;

  CurrencyViewModel({required this.userRepository, required this.user, required this.currency, required this.currencyData});
  ...
  String? get totalFiatAmount {
    ...
    if (currencyData.data?.value.totalAmount != null && currency.data != null && fiatSymbol != null) {
      ...
      final currencyFormatter = NumberFormat.currency(locale: 'en', decimalDigits: 2, symbol: fiatSymbol);

      return '${currencyFormatter.format(totalFiatAmount).replaceAll(fiatSymbol, '')} ${fiatSymbol.toUpperCase()}';
    }
